...
class Login extends React.Component {
    ...
    handleSubmit = (event) => {
        ...
        axios
          ...
          .then((res) => {
            this.setState({ email: "", password: "", isLoading: false, registerLabel: 'Login to your dashboard' });
            toastr.success({ type: _constants.LOGIN_SUCCESS });
          })
          .catch((err) => {
            toastr.error({ type: _constants.LOGIN_INVALID });
            this.setState({ isLoading: false, registerLabel: 'Login to your dashboard'})
        });
    };
                        ...
                        <div className="col-11 col-lg-10 col-xl-6">
                            <div>
                                ...
                                <form onSubmit={this.handleSubmit}>
                                    ...
                                    <div className="mt-4"><Button type="submit" loading={this.state.isLoading} disabled={!this.state.email || !this.state.password} className="btn btn-block btn-primary">{ this.state.loginLabel}</Button></div>
                                </form>
